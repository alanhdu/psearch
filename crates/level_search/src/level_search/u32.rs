...
mod test {
    ...
    fn test_levelsearch_insert_1() {
        ...
        assert_eq!(
            ...
            Descendant {
                ...
                maxes: ByteMap::from_iter(vec![(0xde, nonnull)])
            }
        );
        ...
        assert_eq!(
            ...
            HashMap::from_iter(vec![(
                ...
                Descendant {
                    ...
                    maxes: ByteMap::from_iter(vec![(0xad, nonnull)])
                }
            )])
        );
        ...
        assert_eq!(
            ...
            HashMap::from_iter(vec![(
                ...
                Descendant {
                    ...
                    maxes: ByteMap::from_iter(vec![(0xbe, nonnull)])
                }
            )])
        );
        ...
        assert_eq!(
            ...
            HashMap::from_iter(vec![(
                ...
                Descendant {
                    ...
                    maxes: ByteMap::from_iter(vec![(0xef, nonnull)])
                }
            )])
        );
    }
    ...
    fn test_levelsearch_insert_4() {
        ...
        assert_eq!(
            ...
            Descendant {
                min: Some((0xba, nn1)),
                maxes: ByteMap::from_iter(vec![(0xba, nn1), (0xde, nn4)])
            }
        );
        assert_eq!(
            lss.l1,
            HashMap::from_iter(vec![
                (
                    ...
                    Descendant {
                        min: Some((0xad, nn1)),
                        maxes: ByteMap::from_iter(vec![(0xad, nn1)])
                    }
                ),
                (
                    [0xde],
                    Descendant {
                        min: Some((0xad, nn2)),
                        maxes: ByteMap::from_iter(vec![(0xad, nn4)])
                    }
                )
            ])
        );
        ...
        assert_eq!(
            ...
            HashMap::from_iter(vec![
                (
                    ...
                    Descendant {
                        min: Some((0xf0, nn1)),
                        maxes: ByteMap::from_iter(vec![(0xf0, nn1)])
                    }
                ),
                (
                    [0xde, 0xad],
        ...
        assert_eq!(
            ...
            HashMap::from_iter(vec![
                (
                    ...
                    Descendant {
                        min: Some((0x0d, nn1)),
                        maxes: ByteMap::from_iter(vec![(0x0d, nn1)])
                    }
                ),
                (
                    [0xde, 0xad, 0xbe],
                    Descendant {
                        min: Some((0xef, nn2)),
                        maxes: ByteMap::from_iter(vec![(0xef, nn2)])
                    }
                ),
                (
                    [0xde, 0xad, 0xc0],
